...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'BY_FIRST_NAME' => ['type' => 'index', 'columns' => ['first_name'], 'length' => []],
            'BY_LAST_NAME' => ['type' => 'index', 'columns' => ['last_name'], 'length' => []],
            'BY_EMAIL' => ['type' => 'index', 'columns' => ['email'], 'length' => []],
            'BY_MESSAGE' => ['type' => 'index', 'columns' => ['message'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-11 11:19:46',
            'modified' => '2016-11-11 11:19:46'
        ],
    ];
}
